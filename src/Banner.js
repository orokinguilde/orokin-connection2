                    ...
                    Canvas.loadImage(iconXpVocal).then(function (iconXpVocal) {
                        Canvas.loadImage(iconXpText).then(function (iconXpText) {
                            Canvas.loadImage(iconLevelName).then(function (iconLevelName) {
                                ...
                                var method = drawMethods[template.template.drawMethod || ''];
                                if (method) {
                                    method();
                                }
