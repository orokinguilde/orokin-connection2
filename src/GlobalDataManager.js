...
exports.GlobalDataManager = void 0;
var GlobalDataManager = /** @class */ (function () {
    function GlobalDataManager() {
        this.entries = [];
    }
    GlobalDataManager.prototype.register = function (name, getter) {
        this.entries.push({
            name: name,
            getter: getter
        });
    };
    GlobalDataManager.prototype.get = function (name, join) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        values = _a.sent();
                        if (join) {
                            return [2 /*return*/, values.join(join)];
                        }
                        else {
