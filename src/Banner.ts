...
export class Banner {
    ...
    public async createCanvas(template: IBannerTemplate, callback?: (e: any, data: any) =>void) {
        const width = 550;
        const height = 140;
        ...
        let avatarImgUrl = this.options.avatarUrl;
        let serverImgUrl = config.server.info.rankBannerImgUrl;
